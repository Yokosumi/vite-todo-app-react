    ...
    switch (action.type) {
        ...
        case 'changeEditing':
            if (typeof action.payload === 'object') {
                const changeEditing: IChangeEditing =
                    action.payload as IChangeEditing
    ...
    return (
        <div className="text-white m-6">
            ...
            <div className="flex gap-2 mb-5">
                <input
                    className="text-3xl rounded text-orange-950"
                ...
                />{' '}
                <button
                    className="bg-slate-800 text-slate-400 p-2 rounded"
                    onClick={() =>
                        dispatch({
                            type: 'addTodo',
                            payload: state.newTodoText,
                        })
                    }
                >
                    Add Todo
                        ...
                        <li key={index}>
                            {todo.mode === 'editing' ? (
                                <div className="flex gap-2 text-xl">
                                    ...
                                    />{' '}
                                    <BiSolidSave
                                        className="cursor-pointer text-lg mt-[.25rem]"
                                        onClick={() =>
                                            dispatch({
                                                type: 'saveEditing',
                                                payload: index,
                                    ...
                                    />
                                    <GiCancel
                                        className="cursor-pointer text-base mt-[.3rem]"
                                        onClick={() =>
                                            dispatch({
                                                type: 'cancelEditing',
                                                payload: index,
                                ...
                                <div className="flex gap-2 text-xl">
                                    ...
                                    <BsPencilFill
                                        className="cursor-pointer text-sm mt-[.4rem]"
                                        onClick={() =>
                                            dispatch({
                                                type: 'editTodo',
                                                payload: index,
